          ...
          <div class="col-sm-offset-2 col-sm-8">
            ...
            <h1>Veuillez vous connecter</h1>
              ...
              <button class="btn btn-default">Se connecter</button>
                <br> <br>
              <a href="http://164.132.54.249/stagiaire/sta2/leCV/sites/site_v2/client/inscription.php" class="btn btn-default">Vous n'êtes pas encore inscrits ? Inscrivez-vous !</a>
                <br> <br>     
              <a href="http://164.132.54.249/stagiaire/sta2/leCV/sites/site_v2/client/forget.php" class="btn btn-default">Mot de passe oublié ?</a>
              </p>
            </form>
          </div>
        </div>
